...
export const PLANS: Record<PlanId, PlanConfig> = {
  FREE: {
    ...
    features: [
      "1 product launch",
      "Founder profile with Person schema",
      "Verified review collection (up to 10/mo)",
      "SEO-ready product page with JSON-LD",
      "Listed in /today launch feed",
      "Community support",
    ],
  },
  STARTER: {
    ...
    features: [
      "Everything in Free",
      "Up to 3 product launches",
      "AI-generated meta titles & descriptions",
      "Verified MRR badge on your profile",
      "Launch-day embed kit & countdown widget",
  ...
  GROWTH: {
    ...
    features: [
      ...
      "Up to 10 product launches",
      "Auto-submit to 200+ directories",
      "Keyword rank & backlink tracking",
      "llms.txt feed — cited by ChatGPT, Claude & Perplexity",
